...
experiment_count=0
total_experiments=$((${#SEEDS[@]} * ${#BATCH_SIZES[@]} * ${#REPULSION_STRENGTHS[@]} * ${#DISTANCES[@]}))
    ...
    for batch_size in "${BATCH_SIZES[@]}"; do
        for repulsion_strength in "${REPULSION_STRENGTHS[@]}"; do
            for distance in "${DISTANCES[@]}"; do
                ...
                PARAM_SUFFIX="_rs${repulsion_strength}_bs${batch_size}_${distance}"
                ...
                echo "Seed: ${seed}, Batch Size: ${batch_size}, Repulsion: ${repulsion_strength}, Distance: ${distance}"
                echo "=========================================="
