...
def load_clip_to_cpu(cfg):
    ...
    design_details = {"trainer": 'APP',
                      "vision_depth": 0,
                      "language_depth": 0, "vision_ctx": 0,
                      "language_ctx": 0}
    model = clip_app.build_model(state_dict or model.state_dict())
...
class CustomCLIP(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        self.eps = 0.1
        self.alpha=cfg.TRAINER.APP.ALPHA
        self.max_iter = 100
...
class APP(TrainerX):
    ...
    def forward_backward(self, batch):
        ...
        if prec == "amp":
            ...
            loss += (regular*(self.cfg.TRAINER.APP.REG))
    ...
    def model_inference(self, x):
        return self.model.forward_test(x)[0]
