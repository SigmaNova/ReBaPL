...
AVAI_SCHEDS = ["single_step", "multi_step", "cosine", "cosine_restart"]
...
def build_lr_scheduler(optimizer, optim_cfg, lr_scheduler, cycle_length=None, max_epoch=None):
    ...
    elif lr_scheduler == "cosine_restart" and cycle_length is not None:
        scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(
            optimizer, T_0=cycle_length, T_mult=1, eta_min=0, last_epoch=-1
        )
